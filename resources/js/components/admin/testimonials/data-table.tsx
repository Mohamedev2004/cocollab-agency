  ...
  return (
    <div>
      <div className="flex items-center py-4 space-x-2">
        ...
        <Input
          placeholder="Search testimonial's name..."
          value={(table.getColumn("testimonial_name")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("testimonial_name")?.setFilterValue(event.target.value)
          }
          className="max-w-sm"
        />
