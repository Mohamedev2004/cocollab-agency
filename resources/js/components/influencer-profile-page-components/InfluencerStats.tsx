              ...
              <ChartTooltip
                ...
                content={({ active, payload }) => {
                  if (active && payload && payload.length) {
                    ...
                    return (
                      <div className="flex items-center gap-2 rounded-md bg-white px-3 py-2 shadow-md border-none">
                        <span
                ...
                <ChartTooltip
                  ...
                  content={({ active, payload }) => {
                    if (active && payload && payload.length) {
                      const data = payload[0].payload;
                      return (
                        <div className="rounded-xl bg-white px-3 py-2 shadow-md border-none">
